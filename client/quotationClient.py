...
from parser.quotation import company_info, file, server
...
from const import BLOCK_FILE_TYPE, CATEGORY, FILTER_TYPE, PERIOD, MARKET, SORT_TYPE, ADJUST, main_hosts
from parser.quotation import stock
