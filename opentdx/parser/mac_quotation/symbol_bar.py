...
class SymbolBar(BaseParser):
    def __init__(self, market: Union[MARKET, EX_MARKET], code: str, period: PERIOD, times: int = 1, start: int = 0, count: int = 700, adjust: ADJUST = ADJUST.NONE):
        self.body = struct.pack("<H22sHH I HH bbb bH4s", market.value, code.encode("gbk"), period.value, times, start, count, adjust.value, 1, 1, 0, 1, 0, b"")
        self.period = period
