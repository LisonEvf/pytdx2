...
from opentdx.const import EX_CATEGORY, MARKET, PERIOD, ADJUST
...
class SymbolBar(BaseParser):
    def __init__(self, market: Union[MARKET, EX_CATEGORY], code: str, period: PERIOD, times: int = 1, start: int = 0, count: int = 700, fq: ADJUST = ADJUST.NONE):
